...
export default function Detail() {
  ...
  const message = `Olá ${incident.name}, estou entrando em contato pois gostaria de ajudar com o caso "${incident.title}" com o valor de ${resolveCurrencyValue(incident.value)}`
  ...
  function resolveCurrencyValue(value) {
    ...
    <View style={style.container}>
      ...
      <View style={style.incident}>
        ...
        <Text style={style.incidentValue}>
          {resolveCurrencyValue(incident.value)}
        </Text>
      </View>
